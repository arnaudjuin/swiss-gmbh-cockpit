...
export interface ForecastMonth {
  key: string; label: string; income: number; passive: number; income_override: boolean;
...
export interface ForecastPL {
  ...
  vehicle_depreciation: number; vehicle_depreciation_source: "booked" | "projection" | "none";
